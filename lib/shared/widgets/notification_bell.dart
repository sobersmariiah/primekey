    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text('No notifications yet', style: TextStyle(fontFamily: 'Ubuntu', color: Colors.grey)),
        ],
      ),
    );
  }
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontFamily: 'Ubuntu', fontSize: 10, color: Colors.grey.shade600),
                      ),
                    ],
                  ),
                  SizedBox(height: 4),
                  Text(
                    ...
                    style: TextStyle(fontFamily: 'Ubuntu', fontSize: 13, color: Colors.grey.shade800),
                  ),
                ],
              ),
            ),
