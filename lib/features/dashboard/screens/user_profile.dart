          ...
          builder: (context, ref, _) => SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text('Edit Profile',
                  style:
                      TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w800)),
                    ...
                    children: [
                      ...
                      Center(
                        child: Text(
                          ...
                          style:
                              TextStyle(fontFamily: 'Ubuntu', fontSize: 11, color: Color(0xFFCBD5E1)),
                        ),
                      ),
                      SizedBox(height: 32),
                    ],
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                textStyle:
                    TextStyle(fontFamily: 'Ubuntu', fontSize: 15, fontWeight: FontWeight.w600),
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12)),
              ),
            ),
