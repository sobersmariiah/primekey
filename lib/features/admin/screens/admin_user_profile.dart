  ...
  Widget _buildApplicationItem(BuildContext context, LoanApplicationModel app) {
    ...
    return ListTile(
      ...
      title: Text(
        ...
        style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.bold, fontSize: 15),
      ),
      subtitle: Text(
        '${app.loanDuration} Months • ${Formatters.date(app.createdAt)}',
        style: TextStyle(fontFamily: 'Ubuntu', fontSize: 12, color: AppColors.textSecondary),
      ),
      trailing: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
  ...
  return Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(value,
            style: TextStyle(fontFamily: 'Ubuntu', fontSize: 15, fontWeight: FontWeight.w600)),
      ],
    ),
  );
}
