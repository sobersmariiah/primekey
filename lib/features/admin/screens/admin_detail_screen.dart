    ...
    return showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Reject Application', 
          style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w800)),
        content: Column(
              ...
              children: [
                Expanded(
                  child: TextButton(
                    ...
                    child: Text('Cancel', style: TextStyle(fontFamily: 'Ubuntu', color: AppColors.textSecondary, fontWeight: FontWeight.bold)),
                  ),
                ),
                SizedBox(width: 16),
                Expanded(
                  child: ElevatedButton(
                    ...
                    child: Text('Reject', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.bold)),
                  ),
                ),
              ],
            ),
      ...
      child: app.documentUrls.isEmpty
          ? Center(
              child: Padding(
                ...
                child: Text('No documents uploaded', style: TextStyle(fontFamily: 'Ubuntu', color: AppColors.textSecondary)),
              ),
            )
          : GridView.builder(
              shrinkWrap: true,
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: _isApproving ? const _LoadingSpinner() : Text('APPROVE', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w800)),
                  style: ElevatedButton.styleFrom(
              ...
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: _isRejecting ? const _LoadingSpinner() : Text('REJECT', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w800)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: AppColors.error,
                    foregroundColor: Colors.white,
                    elevation: 0,
  ...
  Widget _buildDangerZone(BuildContext context, LoanApplicationModel app, bool isDesktop) {
    return _buildThemeCard(
      ...
      child: OutlinedButton.icon(
        onPressed: _isActionLoading ? null : () async {
          final confirm = await showDialog<bool>(
            ...
            builder: (ctx) => AlertDialog(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(24)),
              title: Text('Delete Application?', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w800)),
              content: Text('This action is permanent and cannot be undone.', style: TextStyle(fontFamily: 'Ubuntu', )),
              actions: [
                TextButton(onPressed: () => Navigator.pop(ctx, false), child: Text('CANCEL', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.bold))),
                TextButton(
                  onPressed: () => Navigator.pop(ctx, true),
                  child: Text('DELETE', style: TextStyle(fontFamily: 'Ubuntu', color: AppColors.error, fontWeight: FontWeight.w900)),
                ),
              ],
            ),
          );
        ...
        label: Text(_isDeleting ? 'DELETING...' : 'DELETE APPLICATION', style: TextStyle(fontFamily: 'Ubuntu', fontWeight: FontWeight.w800)),
