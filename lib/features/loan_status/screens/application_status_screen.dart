        ...
        children: [
          ...
          if (application.documentUrls.isEmpty)
            Text('No documents submitted',
                style:
                    TextStyle(fontFamily: 'Plus Jakarta Sans', color: AppColors.textSecondary))
          else
            Wrap(
              spacing: 24,
              runSpacing: 24,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(Formatters.currency(application.monthlyIncome, countryCode),
              style:
                  TextStyle(fontFamily: 'Plus Jakarta Sans', fontSize: 15, fontWeight: FontWeight.w700)),
        ],
      ),
    );
  }
  ...
  Widget _detailRow(String label, String value, {bool isBold = false}) {
    return Row(
      ...
      children: [
        Text(label,
            style:
                TextStyle(fontFamily: 'Plus Jakarta Sans', fontSize: 14, color: AppColors.textSecondary)),
        Text(value,
            style: TextStyle(fontFamily: 'Plus Jakarta Sans', 
                fontSize: 14,
    ...
    return SizedBox(
      ...
      child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          ...
          shape:
              RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
          textStyle: TextStyle(fontFamily: 'Plus Jakarta Sans', fontSize: 15, fontWeight: FontWeight.w600),
        ),
      ),
    );
  }
